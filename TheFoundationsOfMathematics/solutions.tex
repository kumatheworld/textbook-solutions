...
\begin{customthm}{I.10.6} Below is the proof.
\begin{flushleft}
\begin{tabular}{lll}
...
\begin{customthm}{I.11.10} Below is the proof.
\begin{flushleft}
\begin{tabular}{lll}
...
\begin{customthm}{I.11.11} Below is the proof. Here $GP=\{\gamma_1,\gamma_2\}$, $\gamma_1=\forall xyz[x\cdot yz=xy\cdot z]$ and $\gamma_2=\exists u[\forall x[xu=ux=x]\wedge\forall x\exists y[xy=yx=u]]$ as defined in the textbook.
\begin{center}
\begin{tabular}{llr}
  ...
  && Deduction Theorem, type 4 axiom, tautology \\
  3. & \multicolumn{2}{l}{$GP\cup\{ab=ac\}\vdash_{\mathcal{L}'}b=c$} \\
  && Deduction Theorem, tautology \\
  4. & \multicolumn{2}{l}{$GP\vdash_\mathcal{L}\forall xyz[xy=xz\rightarrow y=z]$} \\
  && Deduction Theorem, UG
\end{tabular}
\end{center}
\end{customthm}

\begin{customthm}{I.11.13} Let $\varphi_0,\ldots,\varphi_n$ be a formal proof of $\varphi$ from $\Sigma$ in $\mathcal{L}_1$ and let $\mathcal{L}_0'=\mathcal{L}_0\cup\{c\}$ where $c\not\in\mathcal{L}_0$ is a constant symbol. Let $F$ be a function that turns any formula $\varphi\in\mathcal{L}_1$
