...
\begin{customthm}{I.11.17} Let $A$ be a set. To prove the 'only if' part, assume $\omega\preceq A$ and let $i:\omega\rightarrow A$ be an injection. Then we can define an injection $f:A\rightarrow A$ with $\mathrm{ran}(f)\neq A$ as follows.
  \[f(x)=
    \begin{cases}
