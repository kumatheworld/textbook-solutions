...
\begin{customthm}{I.15.10} (half-done)
  ...
  To prove that every Luzin set has Lebesgue measure $0$, we show that every set of positive measure has a first category subset of positive measure, which means that a Luzin set of positive measure would have an uncountable intersection with a first category subset, contradicting the definition of Luzin sets. The proof is coming soon.
\end{customthm}
