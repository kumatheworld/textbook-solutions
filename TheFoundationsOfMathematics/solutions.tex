...
\begin{customthm}{IV.3.31} (half-done)
  ...
  \begin{enumerate}
    ...
    \item\underline{$F(x)=x$ for all $x\in A$ such that $\trcl(x)\subseteq A$}. Coming soon.
    \item\underline{There is a countable transitive $T\models ZFC-P$ such that $\approx$ is not absolute for $T$}. Coming soon.
  \end{enumerate}
\end{customthm}
