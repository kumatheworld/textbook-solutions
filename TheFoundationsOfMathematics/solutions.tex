...
\begin{customthm}{IV.4.14} (half-done)
  ...
  Furthermore, we call a decimal expansion is in normal form when it has no infinite consecutive repetition of $9$. Note that any decimal expansion has a unique normal form as the repeating $9$'s can be all replaced by $0$'s, incrementing the digit right before the first $9$ of the infinite repetition. Therefore, we may assume that any decimal expansion is in normal form throughout the exercise.
