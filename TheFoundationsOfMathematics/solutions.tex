...
\begin{customthm}{I.15.11} (half-done)
  ...
  Let $X\subseteq\mathbb{R}$ be a Sierpiński set. To prove that $X$ cannot be measurable, we show that the measure of $X$ cannot be neither $0$ or positive. It is clear that the measure cannot be 0 since $X$ would be countable and uncountable at the same time. To see that $X$ cannot have positive measure, we show
   that any set of positive measure has a null subset of the same cardinality. The proof is omitted for now.
\end{customthm}
