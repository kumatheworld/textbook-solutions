...
\begin{customthm}{IV.4.14} (half-done)
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item\underline{$x,y\in J\rightarrow x\cdot y\in J$}. (half-done) Let $x,y\in J$. We show $x\cdot y\in J$ by gradually generalizing $y$ as follows.
      \begin{enumerate}
        ...
        \item\underline{$y\in J$}. Coming soon.
      \end{enumerate}
    \end{enumerate}
