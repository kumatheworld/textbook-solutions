...
\begin{customthm}{I.9.6}
  Assume Lemma I.9.5(2). For Infinity, we consider the class of natural numbers $A$ and a relation $R$ defined by $xRy\leftrightarrow x=S(y)$. Since $R$ is set-like on $A$, $R^*$ is set-like too by the assumption. Then $\textrm{pred}_{R^*}(0)=\{x\in A:x=S(S(\cdots (S(0))))\}=A$ turns out to be a set.
\end{customthm}
