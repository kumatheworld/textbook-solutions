...
\begin{customthm}{I.9.43}
  Assume $WF\not\subseteq K$ and let $x$ be an $\in$-minimal element of $WF\setminus K$. Since $x\not\in K$, $x\not\subseteq K$ holds and hence there is $y\in x\setminus K$, which contradicts the minimality of $x$. Thus $WF\subseteq K$ holds.
\end{customthm}
